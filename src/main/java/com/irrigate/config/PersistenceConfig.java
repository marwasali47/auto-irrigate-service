...
import com.irrigate.AutoIrrigateServiceApplication;
...
@Configuration
@EnableJpaRepositories(basePackageClasses = AutoIrrigateServiceApplication.class)
public class PersistenceConfig {
    ...
    public static String PACKAGE_TO_SCAN = "com.irrigate";
    @Bean
